...
```
.reward | .reload | .die | .grab | .flipcoin | .catfact | .dogfact | .hug | .8ball | .punish | .fortune | .songlink | download | .help | .whywoot | .whymeh | .props | .votes | .woot | .meh | .skip | .say | .version | .userstats | .mystats | source | .set {rank} | .queup | .quedown | .add | .remove | .creator | .status | .ban | .bf | .cf | tbf | tcf
```
`example 1`
```
#Tools: .commands @Neon
